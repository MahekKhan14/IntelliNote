...
function Footer() {
    ...
    return (
        <motion.div
            ...
            className='z-10 mx-6 mb-6 mt-24 rounded-2xl bg-gradient-to-br
        ...
        border border-white/10 px-8 py-8 shadow-[0_25px_60px_rgba(0,0,0,0.7)]'>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 items-start'>
                <motion.div
                    ...
                    <div className='flex flex-items-center gap-3 cursor-pointer'
                        style={{ transformStyle: "translateZ(20px)" }}>
                    ...
                    <p className='text-sm text-gray-300 max-w-sm'>
                        IntelliNote helps you generate structured notes, visualize concepts with diagrams, and organize knowledge effortlessly using AI.
                    </p>
                </motion.div>
            ...
            <p className='text-center text-xs text-gray-500'>
             ©️ {new Date().getFullYear()} IntelliNote⭐. All Rights reserved.
            </p>
