    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8">
            <motion.header
                ...
                className="mb-10 rounded-2xl bg-black/80 backdrop-blur-xl border border-white/10 px-8 py-6 flex justify-between md:items-center gap-4 flex-wrap shadow-[0_20px_45px_rgba(0,0,0,0.6)]"
            >
                <div onClick={() => navigate("/")} className="cursor-pointer">
                    ...
                    <p className="text-sm text-gray-300 mt-1">
                        An AI-powered note-taking platform that transforms complex topics
                        into structured notes, documentation, diagrams, and
                ...
                <div className="flex items-center gap-4 flex-wrap">
                    ...
                    >
                        <span className="text-lg flex items-center leading-none -translate-y-[1px]">
                            💎
                        </span>
                ...
                <AnimatePresence>
                    {isSidebarOpen && (
                        <motion.div
                            ...
                            className="fixed lg:static top-0 left-0 z-50 lg:z-auto w-72 lg:w-auto h-full lg:h-[75vh] lg:rounded-3xl lg:col-span-1 bg-black/90 lg:bg-black/80 backdrop-blur-xl border border-white/20 shadow-[0_20px_45px_rgba(0,0,0,0.6)] p-5 overflow-y-auto"
                        >
                            <button
